      ...
      {loading ? (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px,1fr))", gap: 10 }}>
          {banks.map(b => {
            ...
            const rateDir = b.forecast > b.currentRate ? "▲" : b.forecast < b.currentRate ? "▼" : "—";
            const rateDirColor = b.forecast > b.currentRate ? "#22c55e" : b.forecast < b.currentRate ? "#ef4444" : "#94a3b8";
